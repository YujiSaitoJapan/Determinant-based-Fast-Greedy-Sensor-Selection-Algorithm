...
[Perror_rand,Perror_std_rand] = Percent_error(TT,Xorg, Psi, Xestimate_rand,r);

% convex
[Xestimate_convex]= reconst(Xorg,H_convex,Psi,r);
[Perror_convex,Perror_std_convex] = Percent_error(TT,Xorg, Psi, Xestimate_convex,r);
% QR
[Xestimate_QR]= reconst(Xorg,H_QR,Psi,r);
[Perror_QR,Perror_std_QR] = Percent_error(TT,Xorg, Psi, Xestimate_QR,r);
% DG
[Xestimate_DG]= reconst(Xorg,H_DG,Psi,r);
[Perror_DG,Perror_std_DG] = Percent_error(TT,Xorg, Psi, Xestimate_DG,r);
% QD
[Xestimate_QD]= reconst(Xorg,H_QD,Psi,r);
[Perror_QD,Perror_std_QD] = Percent_error(TT,Xorg, Psi, Xestimate_QD,r);
end